#ifndef RASTERIZE_STATE_H
#define RASTERIZE_STATE_H
...
class RasterizerState : public engine_base::Objects
{
public:
    /**
    ...
    */
    virtual void SetViewport(const engine_graphic::Viewport &viewport) = 0;
    virtual void SetViewports(const std::vector<engine_graphic::Viewport> &viewports) = 0;
    virtual const std::vector<engine_graphic::Viewport> &GetViewports() = 0;
    ...
    */
     ...
     */
    virtual void SetScissorRect(const engine_base::Rect &rect) = 0;
    virtual void SetScissorRects(const std::vector<engine_base::Rect> &rects) = 0;
    virtual const std::vector<engine_base::Rect> &GetScissorRects() const = 0;
