...
//UINT BspTree::m_sNumPolyOfTree = 0;
...
void BspTree::BuildTree( const RTMath::Polygon* pPolygons, UINT uNum )
{
	if ( uNum < 1 )
	{
		return;
...
void BspTree::AddPolygon(const RTMath::Polygon& polygon )
{
...
void BspTree::CalcBoundingBox(const RTMath::Polygon* pPolygons, unsigned int uNum )
{
