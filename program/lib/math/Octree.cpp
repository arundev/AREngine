...
void Octree::BuildTree( const RTMath::Polygon* pPolygons, UINT nNum )
{
	m_pRoot = this;
	if ( nNum < 1 )
	{
...
void Octree::CalcBoundingBox( const RTMath::Polygon* pPolygon, UINT nInt )
{
...
void Octree::ChopListToMe( RTMath::Polygon* pPolygons, UINT nNum )
{
	Polygon tempPolygon;
